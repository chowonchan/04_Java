...
//		Integer wrap1 = new Integer(num1);
		...
		Integer wrap1 = num1; // (int) 와 Integer는 다른 자료형이지만 오류안남
		// -> 컴파일러가 AutoBoxing을 수행하여
		//	  오류가 발생하지 않음
