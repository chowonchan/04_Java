...
public class SetService {
	...
	public void test4() {
		...
		Set<Integer> lotto = new TreeSet<Integer>(); // 중복 제거
		
		
		while( lotto.size() < 6 ) { // 정해진 횟수가 될때 까지
...
//			System.out.println(i +"회 : " + lottoList.get(i-1));
