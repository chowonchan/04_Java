...
public class ThrowsService {
	 ...
	 *     사방에 흩어져 있을 경우
	 *     돌려 받는 최종 결과가
	 *     정상 결과인지, 예외 처리된 결과인지 구분하기 힘들어지는 경우 발생
	 */
...
//			throw new IOException("강제 예외 발생");
	 ...
	 * @throws Exception
	 */
	public void forcedExcetption() throws Exception{
