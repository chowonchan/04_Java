...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * -문자형-
		 * char  (2byte) - 문자 하난를 의미, 'A' 형식으로 작성
		 * */
		
		// 변수 선언: 메모리에 값을 저장할 공간을 만듦(== 할당)
		int num1; // 메모리에 int형 데이터를 저장하기 위한 공간
		...
		//int intNu2 = 2147483648; // int 최대값 +1
		
		//long longNum = 2147483647; // 일반 정수값 == int (기본형)
...
//		char ch6 = "A";  // 쌍따옴표 "" 안됨
		...
		System.out.println("float  : " + test1); // 소수점 7~8자리 까지
		System.out.println("double : " + test2); // 소수점 15~16자리 까지
