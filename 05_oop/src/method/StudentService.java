...
public class StudentService {
	...
	// 필드
	// 이 클래스에서만 사용하는 스케너 객체 sc생성 매개변수[System.in] <- 키보드를 의미
	...
	public void mainMenu() {
		...
		do {
			...
			sc.nextLine(); // 입력 버퍼에 남아 있는 엔터 제거
			...
			default: System.out.println("=== 알맞은 메뉴 번호 입력해주세요 ===");
	...
	public void studyJava(Student std) {
		...
		System.out.print("증가 또는 감소한 Java역량 점수 입력 : ");
	...
	private void studyHtml(Student std) {
		...
		System.out.println("증가 또는 감소한 HTML역량 점수 입력 : ");
		int score = sc.nextInt();
