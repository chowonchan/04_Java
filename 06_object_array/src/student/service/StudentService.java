...
public class StudentService {
	...
	public StudentService() {
		...
		// students[0] : StudentDTO 자려형 참조 변수
	...
	/**
	 * 학생 객체 배열 students 중 비어 있는 인덱스에
	 * 전달 받은 학생 객체 (std) 추가
	 * @param std : 입력 받은 값으 ㄹ저장한 학생 객체 주소
	...
	public boolean addStudent(StudentDTO std) {
		...
		// 더이상 비어있는(null) 요소가 없을때 false 반환
		return false;
	}
	 ...
	 *  + 정상 범위라면 해당 index에 학생 객체를 참조하는 지 확인
	 * @param index
